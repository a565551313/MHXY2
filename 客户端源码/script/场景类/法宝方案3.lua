...
function 法宝方案3:更新(x,y)
	self.x = x + 257
	self.y = y - 130
end

function 法宝方案3:显示(dt,x,y)
	local 字体 = tp.字体表.普通字体
	self.焦点 = false
	self.关闭:更新(x,y)
	self.更换:更新(x,y)
