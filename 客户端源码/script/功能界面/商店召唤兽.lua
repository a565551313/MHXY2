 ...
 for n=1,12 do
     ...
     --print(self.名称[n])
      if self.名称[n]~=nil then
         ...
         tp.字体表.排行字体1:置颜色(颜色):显示(self.x+165,self.y+34+位置*23,"野怪")
         ...
         tp.字体表.排行字体1:置颜色(绿色):显示(self.x+165,self.y+34+位置*23,"野怪")
         ...
         tp.字体表.排行字体1:置颜色(黑色):显示(self.x+165,self.y+34+位置*23,"野怪")
