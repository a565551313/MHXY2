...
function 藏宝阁购买寄存:初始化(根)
    ...
    self.上按钮:绑定窗口_(116)
    self.下按钮:绑定窗口_(116)
    self.资源组[2]:绑定窗口_(116)
    self.资源组[6]:绑定窗口_(116)
    self.资源组[7]:绑定窗口_(116)
    for i=1,5 do
        self.道具按钮[i]:绑定窗口_(116)
    end
    self.boxh=40
    self.boxw=225
    self.数据={}
...
function 藏宝阁购买寄存:显示(dt,x,y)
    ...
    elseif self.资源组[6]:事件判断()  then---------上架按钮
            ...
            elseif self.识别码 =="" or self.识别码 == nil  then
               ...
               请求服务(69,{类型=self.商城类型,文本="上架购买商品",编号=self.识别码,价格=self.输入框:取文本()})
             end
        ...
        elseif self.资源组[7]:事件判断()  then
            ...
            elseif self.识别码 =="" or self.识别码 == nil  then
               ...
               请求服务(69,{类型=self.商城类型,文本="取回商品",编号=self.识别码,类别="购买"})
            end
...
function 藏宝阁购买寄存:开始移动(x,y)
    if self.鼠标 then
        self.x = x - self.xx
        self.y = y - self.yy
    end
end
function 藏宝阁购买寄存:更新(dt) end
