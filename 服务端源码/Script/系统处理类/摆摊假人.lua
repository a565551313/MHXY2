...
function 摆摊假人类:初始化()
          ...
          if 摆摊假人 then
             for i,v in ipairs(摆摊假人) do
                  if v.地图 and v.x and v.y and v.摊位名称 then
                        ...
                        -- 无条件覆盖武器字段，确保每个摆摊假人100%有武器
                        local 模型 = 假人信息.模型
                        local 序列 = 角色武器类型[模型][取随机数(1,2)]
                        local 物品 = 假人玩家类.装备物品[序列]
                        local 武器物品  = 物品[取随机数(1,#物品)]
                        假人信息.武器 = 假人玩家类:生成指定装备(武器物品,序列)
          ...
          -- if 假人信息 then
          --     print("[摆摊假人]", 假人信息.名称 or "", 假人信息.模型 or "", (假人信息.武器 and 假人信息.武器.名称 or tostring(假人信息.武器) or "无"))
          -- end
end
