...
function 刷新商城商品()
  ...
  仙玉商城.神兽商城={商品详情={},一代神兽={},二代神兽={},三代神兽={},四代神兽={}}--{一代神兽={},二代神兽={},三代神兽={},四代神兽={}}
...
function 仙玉商城类:仙玉商城购买(id,类型,序号,数量,大分类)
  ...
  if 仙玉商城[大分类]==nil or 仙玉商城[大分类][类型]==nil or 仙玉商城[大分类][类型][序号]==nil or not 玩家数据[id] or not 共享货币[玩家数据[id].账号] then
    ...
    if 大分类 == "GM商城" then
      ...
      -- GM商城使用GM币购买
      if 玩家数据[id].角色.数据.GM币 < 需求金钱 then
        常规提示(id,"#Y你没有这么多的GM币！")
        return
      end
      玩家数据[id].角色.数据.GM币 = 玩家数据[id].角色.数据.GM币 - 需求金钱
      self:仙玉商城商品处理(id,名称,数量)
      常规提示(id,format("#Y你花费了#R%s#YGM币购买了#R%s",需求金钱,名称))
...
function 仙玉商城类:取仙玉商城商品(id,类型,序号,大分类)
  ...
  if 大分类=="GM商城" then
    ...
    --发送信息.GM币余额 = 玩家数据[id].角色.数据.GM币 or 0
  end
